...
/**
 *	\file       htdocs/citrusmanager/template/citrusmanagerindex.php
 *	\ingroup    citrusmanager
 *	\brief      Home page of citrusmanager top menu
 */
...
$langs->loadLangs(array("citrusmanager@citrusmanager"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->citrusmanager->read) accessforbidden();
...
// dirty redirect to the citrus list (temporary)
echo '<script>
...
echo '<div>' . $langs->trans('RedirectionNotice') . '</div>';
...
if (! empty($conf->citrusmanager->enabled) && $user->rights->citrusmanager->read)
{
